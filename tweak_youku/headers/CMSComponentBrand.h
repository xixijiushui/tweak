...
#import "ChannelBrandViewCellDelegate.h"

@class ChannelBrandViewCell, NSMutableArray, NSString;

@interface CMSComponentBrand : CMSComponent <ChannelBrandViewCellDelegate>
{
    NSMutableArray *_brandsArray;
    ChannelBrandViewCell *_brandViewCell;
}

@property(nonatomic) __weak ChannelBrandViewCell *brandViewCell; // @synthesize brandViewCell=_brandViewCell;
- (void).cxx_destruct;
- (void)channelBrandExposeRange:(struct _NSRange)arg1;
- (void)didSelectBrand:(id)arg1;
