...
@class NSMutableArray, NSString, OPLayoutModel, YKNDOPPlayButtonView;

@interface YKNDOPCenterPlayPlugin : OPPlugin <YKNDOPPlayButtonViewDelegate, OPLayoutModelDelegate>
{
