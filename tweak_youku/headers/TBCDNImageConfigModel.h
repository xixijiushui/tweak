...
@interface TBCDNImageConfigModel : NSObject
{
    ...
    _Bool _domainSwitch;
    _Bool _freeDataSwitch;
    _Bool _gifOssSwitch;
    _Bool _gifScaleSwitch;
    _Bool _decompressImages;
    ...
    NSArray *_freeDataURLs;
    NSArray *_freeDataOriginURLs;
    NSArray *_limitDomains;
    NSArray *_gifOssDomains;
    double _gifOssQuality;
}

@property(nonatomic) _Bool decompressImages; // @synthesize decompressImages=_decompressImages;
@property(nonatomic) double gifOssQuality; // @synthesize gifOssQuality=_gifOssQuality;
@property(nonatomic) _Bool gifScaleSwitch; // @synthesize gifScaleSwitch=_gifScaleSwitch;
@property(retain, nonatomic) NSArray *gifOssDomains; // @synthesize gifOssDomains=_gifOssDomains;
@property(nonatomic) _Bool gifOssSwitch; // @synthesize gifOssSwitch=_gifOssSwitch;
@property(retain, nonatomic) NSArray *limitDomains; // @synthesize limitDomains=_limitDomains;
@property(retain, nonatomic) NSArray *freeDataOriginURLs; // @synthesize freeDataOriginURLs=_freeDataOriginURLs;
@property(retain, nonatomic) NSArray *freeDataURLs; // @synthesize freeDataURLs=_freeDataURLs;
@property(nonatomic) _Bool freeDataSwitch; // @synthesize freeDataSwitch=_freeDataSwitch;
