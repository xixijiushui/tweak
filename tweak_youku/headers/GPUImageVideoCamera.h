...
- (void).cxx_destruct;
@property(readonly, retain, nonatomic) AVCaptureAudioDataOutput *captureAudioOutput;
@property(readonly, retain, nonatomic) AVCaptureVideoDataOutput *captureVideoOutput;
