...
@class AVAssetImageGenerator, AVAssetTrack, AVPlayer, AVPlayerItem, AVPlayerItemVideoOutput, AVPlayerLayer, AVURLAsset, CADisplayLink, LFAVPlayerView, LFAssetResourceLoader, NSObject<OS_dispatch_queue>, NSString, NSURL;
