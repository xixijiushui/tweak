...
#import "ASLayoutElementTransition.h"
...
@interface ASDisplayNode : NSObject <ASDebugNameProvider, ASAsyncTransactionContainer, ASLayoutElement, ASLayoutElementStylability, UIGestureRecognizerDelegate, CALayerDelegate, _ASDisplayLayerDelegate, ASDescriptionProvider, ASDebugDescriptionProvider, _ASTransitionContextCompletionDelegate, ASLayoutElementTransition>
{
...
@property(readonly, nonatomic) _Bool supportsLayerBacking;
...
@property(readonly, nonatomic) ASLayout *unflattenedCalculatedLayout;
...
@property(nonatomic) long long cornerRoundingType;
...
- (id)calculatedLayout;
@property(copy, nonatomic) CDUnknownBlockType layoutSpecBlock;
...
@property(nonatomic) _Bool automaticallyManagesSubnodes;
