...
#import "ASAnimatedImageProtocol.h"
#import "ASImageContainerProtocol.h"

@class ImageLibAPNGDecoder, NSArray, NSData, NSError, NSIndexSet, NSMutableArray, NSMutableIndexSet, NSObject<OS_dispatch_queue>, NSString;

@interface TBAnimatedImage : UIImage <ASImageContainerProtocol, ASAnimatedImageProtocol>
{
...
@property(nonatomic) long long playbackReadyCount;
@property(copy, nonatomic) UIImage *posterImage;
