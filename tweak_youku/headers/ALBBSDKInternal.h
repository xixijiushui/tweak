...
@property(nonatomic) _Bool isNeedConfirmbindPage; // @synthesize isNeedConfirmbindPage=_isNeedConfirmbindPage;
...
- (void)showLoginView:(id)arg1 openUrl:(id)arg2 onlyH5Login:(_Bool)arg3;
- (void)authOnFailure:(id)arg1;
- (void)authOnSuccess;
- (void)autoLogin:(id)arg1 needLoginView:(_Bool)arg2 openUrl:(id)arg3 isBind:(_Bool)arg4 needHud:(_Bool)arg5;
