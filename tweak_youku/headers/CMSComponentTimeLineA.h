...
#import "CMSComponentTimeLineACellDelegate.h"

@class CMSComponentTimeLineACell, NSString;

@interface CMSComponentTimeLineA : CMSComponent <CMSComponentTimeLineACellDelegate, CMSComponentCellProtocol>
{
    CMSComponentTimeLineACell *_timeLineACellView;
}

@property(nonatomic) __weak CMSComponentTimeLineACell *timeLineACellView; // @synthesize timeLineACellView=_timeLineACellView;
- (void).cxx_destruct;
- (void)timeLineACell:(id)arg1 cardVideos:(id)arg2;
