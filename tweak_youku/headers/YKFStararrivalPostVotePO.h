...
@class NSArray<YKFStararrivalPostVoteVOVoteOptionVO>, NSString;

@interface YKFStararrivalPostVotePO : YKFAPIModel
{
    _Bool _expired;
    _Bool _voted;
    ...
    NSArray<YKFStararrivalPostVoteVOVoteOptionVO> *_options;
    NSString *_title;
...
@property(retain, nonatomic) NSArray<YKFStararrivalPostVoteVOVoteOptionVO> *options; // @synthesize options=_options;
