...
@interface DetailComponentActivityBanner : DetailComponent
{
    double _mainCellHeight;
    double _mainCardHeight;
}

@property(nonatomic) double mainCardHeight; // @synthesize mainCardHeight=_mainCardHeight;
