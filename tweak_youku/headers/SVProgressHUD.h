...
@class CAShapeLayer, NSTimer, UIActivityIndicatorView, UIControl, UIImageView, UILabel;
...
+ (id)sharedView;
+ (void)showMsg:(id)arg1 tv:(double)arg2;
...
- (id)hudRingForegroundColor;
- (id)hudRingBackgroundColor;
