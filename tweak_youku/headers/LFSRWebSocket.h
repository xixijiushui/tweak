...
@class LFSRIOConsumerPool, NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest;

@interface LFSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    LFSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    LFSRIOConsumerPool *_consumerPool;
    id <LFSRWebSocketDelegate> _delegate;
    NSURL *_url;
...
@property(nonatomic) __weak id <LFSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)_SR_commonInit;
- (id)initWithURL:(id)arg1 protocols:(id)arg2 urlCookies:(id)arg3;
- (id)initWithURL:(id)arg1 urlCookies:(id)arg2;
