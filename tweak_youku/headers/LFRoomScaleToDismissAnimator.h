...
@interface LFRoomScaleToDismissAnimator : NSObject <UIViewControllerAnimatedTransitioning>
{
    double _damping;
    double _springVelocity;
    double _transitionDuration;
    struct CGPoint _scaleAnchorPoint;
    struct CGPoint _oldScaleAnchorPos;
}

@property(nonatomic) struct CGPoint oldScaleAnchorPos; // @synthesize oldScaleAnchorPos=_oldScaleAnchorPos;
