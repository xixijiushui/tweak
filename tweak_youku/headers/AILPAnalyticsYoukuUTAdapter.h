...
@interface AILPAnalyticsYoukuUTAdapter : NSObject <AILPAnalyticsProtocol>
{
    NSDictionary *_preProperties;
}

@property(copy, nonatomic) NSDictionary *preProperties; // @synthesize preProperties=_preProperties;
- (void).cxx_destruct;
