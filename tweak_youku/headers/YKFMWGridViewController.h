...
@class YKFMWPhotoBrowser;

@interface YKFMWGridViewController : UICollectionViewController
{
    double _margin;
    double _gutter;
    double _marginL;
...
@property(nonatomic) YKFMWPhotoBrowser *browser; // @synthesize browser=_browser;
