...
@class NSString, UICollectionView, YKFReplyContentImagesViewModel, YKFReplyToolImagePlugin<YKFReplyToolNonTextContentProvider>;

@interface YKFReplyContentImagesCell : YKFReplyToolNonTextContentCell <UICollectionViewDataSource, UICollectionViewDelegate, LXReorderableCollectionViewDataSource, LXReorderableCollectionViewDelegateFlowLayout>
{
    _Bool _isDragging;
...
@property(nonatomic) __weak YKFReplyToolImagePlugin<YKFReplyToolNonTextContentProvider> *nonTextContentProvider; // @dynamic nonTextContentProvider;
