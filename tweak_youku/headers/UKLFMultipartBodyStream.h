...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, UKLFHTTPBodyPart;

@interface UKLFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    UKLFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) UKLFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
