...
@class HYStackViewAlignmentStrategy, HYStackViewDistributionStrategy, NSArray, NSMutableArray;

@interface HYStackView : UIView
{
    ...
    HYStackViewAlignmentStrategy *_alignmentStrategy;
    HYStackViewDistributionStrategy *_distributionStrategy;
...
@property(retain, nonatomic) HYStackViewDistributionStrategy *distributionStrategy; // @synthesize distributionStrategy=_distributionStrategy;
@property(retain, nonatomic) HYStackViewAlignmentStrategy *alignmentStrategy; // @synthesize alignmentStrategy=_alignmentStrategy;
...
- (id)heightViewConstraint;
- (id)widthViewConstraint;
