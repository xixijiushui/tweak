...
@class CADisplayLink, NSArray, NSDate, NSProgress, NSString, NSTimer, UIButton, UIColor, UIFont, UILabel, YKFMBBackgroundView;

@interface YKFMBProgressHUD : UIView
{
    ...
    float _progress;
    id <YKFMBProgressHUDDelegate> _delegate;
    ...
    YKFMBBackgroundView *_bezelView;
    YKFMBBackgroundView *_backgroundView;
    UIView *_customView;
    UILabel *_label;
...
@property(readonly, nonatomic) YKFMBBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(readonly, nonatomic) YKFMBBackgroundView *bezelView; // @synthesize bezelView=_bezelView;
...
@property(nonatomic) __weak id <YKFMBProgressHUDDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
