...
- (void)p_play:(id)arg1 identifier:(unsigned long long)arg2 time:(double)arg3 needSeek:(_Bool)arg4 finishBlock:(CDUnknownBlockType)arg5;
- (void)seek:(id)arg1 identifier:(unsigned long long)arg2 time:(double)arg3 finishBlock:(CDUnknownBlockType)arg4;
