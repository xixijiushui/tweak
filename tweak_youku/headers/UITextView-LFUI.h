...
- (void)lf_scrollCaretVisibleAnimated:(_Bool)arg1;
- (void)lf_setAttributedTextKeepingSelectedRange:(id)arg1;
- (void)lf_setTextKeepingSelectedRange:(id)arg1;
- (struct _NSRange)lf_convertNSRangeFromUITextRange:(id)arg1;
@end
