...
@class NSArray, NSString, UIViewController, UIViewController<YKPageDelegate>, YKPagesManager;
...
- (NSString *)ykPagesManager:(YKPagesManager *)arg1 rightIconForPageAtIndex:(long long)arg2;
