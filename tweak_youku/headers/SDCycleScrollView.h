...
@property(nonatomic) int usedType; // @synthesize usedType=_usedType;
...
@property(retain, nonatomic) NSArray *footTitleArray; // @synthesize footTitleArray=_footTitleArray;
...
- (id)initWithFrame:(struct CGRect)arg1 usedType:(int)arg2;
