...
@class NSMutableArray, NSString, OPLayoutModel, YKSTFeedModel, YKSTFeedPlayer, YKSTTopLeftLabel;

@interface YKSTFeedPlayerTitlePlugin : OPPlugin <YKSTFeedPlayerPluginReuseProtocol>
{
    _Bool _hiddenTitle;
    YKSTTopLeftLabel *_titleLabel;
...
@property(retain, nonatomic) YKSTTopLeftLabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (void).cxx_destruct;
- (void)updateView;
