...
@class NSArray, NSMutableArray, NSString, UIColor, YKCZoomSlideView;

@interface CMSComponentZoomSlider : CMSComponent <CMSSlicerViewDelegate, CMSComponentContextAdDelegate, ChannelSliderPlayerDelegate>
{
    _Bool _isDisplaying;
...
@property(nonatomic) __weak YKCZoomSlideView *sliderView; // @synthesize sliderView=_sliderView;
- (void).cxx_destruct;
