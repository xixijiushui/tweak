...
@interface HomeRecommendShareView : UIView <UIScrollViewDelegate, YKShareCenterDelegate>
{
    id <HomeRecommendShareViewDelegate> _delegate;
...
@property(nonatomic) __weak id <HomeRecommendShareViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
