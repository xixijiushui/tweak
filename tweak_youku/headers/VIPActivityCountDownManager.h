...
@interface VIPActivityCountDownManager : NSObject
{
    double _timeInterval;
    double _localDifference;
...
@property(nonatomic) double localDifference; // @synthesize localDifference=_localDifference;
