...
@class ActivityView, NSDate, NSDateFormatter, NSMutableArray, PLPullToRefreshArrow, UIColor, UILabel, UIScrollView;

@interface PLPullToRefreshView : UIView
{
...
@property(retain, nonatomic) PLPullToRefreshArrow *arrow; // @synthesize arrow=_arrow;
