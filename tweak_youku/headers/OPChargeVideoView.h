...
@class CALayer, NSString, OPRevolveTitle, UIButton, UIImageView, UILabel;

@interface OPChargeVideoView : UIView
{
    _Bool _isLogin;
    id <OPChargeVideoViewDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <OPChargeVideoViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
