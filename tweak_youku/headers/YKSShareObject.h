...
#import "YKSShareDelegate.h"

@class NSString, YKSShareOpenPlatformItem;

@interface YKSShareObject : NSObject <YKSShareDelegate>
{
    ...
    NSString *_nickname;
    long long _scene;
    YKSShareOpenPlatformItem *_openPlatformItem;
...
@property(retain, nonatomic) YKSShareOpenPlatformItem *openPlatformItem; // @synthesize openPlatformItem=_openPlatformItem;
