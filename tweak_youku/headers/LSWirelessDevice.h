...
@class LSLiveQualityModel, NSDictionary, NSString;

@interface LSWirelessDevice : NSObject
{
    _Bool _isOffline;
    _Bool _isHasIcon;
    _Bool _isSelected;
...
@property(nonatomic) LSLiveQualityModel *qualityModel; // @synthesize qualityModel=_qualityModel;
...
- (id)initWidthQualityModel:(id)arg1;
