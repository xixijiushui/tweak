...
@class NSString, UIButton, UILabel, UITextField, YKUCSendMessageButton;

@interface YKVerifyCodeView : YKWhiteCardView <UITextFieldDelegate>
{
    UILabel *_titleLabel;
    UILabel *_descriptionLabel;
    UIButton *_changePhoneButton;
    UITextField *_verifyCodeTextField;
    YKUCSendMessageButton *_sendButton;
...
@property(retain, nonatomic) YKUCSendMessageButton *sendButton; // @synthesize sendButton=_sendButton;
