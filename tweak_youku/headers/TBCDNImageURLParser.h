...
+ (_Bool)isYoukuOSSCDN:(id)arg1;
+ (id)getNormalURLFromFreeDataURL:(id)arg1;
+ (id)getFreeDataURL:(id)arg1;
...
+ (id)inner_parseImageURLForCDNURL:(id)arg1 module:(id)arg2 imageSize:(struct CGSize)arg3 viewSize:(struct CGSize)arg4 cutType:(long long)arg5 config:(id)arg6;
