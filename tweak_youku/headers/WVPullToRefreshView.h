...
@class NSMutableArray, UIColor, UILabel, UIScrollView, UIView<WVPullToRefreshIndicatorProtocol>;
...
@interface WVPullToRefreshView : UIView
{
    ...
    UIView<WVPullToRefreshIndicatorProtocol> *_indicator;
...
@property(retain, nonatomic) UIView<WVPullToRefreshIndicatorProtocol> *indicator; // @synthesize indicator=_indicator;
