...
@interface OPLanguageView : UIView <UITableViewDelegate, UITableViewDataSource>
{
    id <OPLanguageViewDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <OPLanguageViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
