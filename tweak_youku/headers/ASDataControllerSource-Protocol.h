...
@class ASCollectionElement, ASDataController, NSArray, NSIndexPath, NSIndexSet, NSString;
...
- (ASCellNode * (^)(void))dataController:(ASDataController *)arg1 supplementaryNodeBlockOfKind:(NSString *)arg2 atIndexPath:(NSIndexPath *)arg3;
