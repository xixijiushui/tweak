...
@class CMSCardVideo, ChannelChildSettingCell;

@interface CMSComponentChildSetting : CMSComponent
{
    CMSCardVideo *_vitruleVideo;
    ChannelChildSettingCell *_settingCell;
}

@property(nonatomic) __weak ChannelChildSettingCell *settingCell; // @synthesize settingCell=_settingCell;
- (void).cxx_destruct;
- (id)controlName;
- (id)spm;
- (id)pageName;
