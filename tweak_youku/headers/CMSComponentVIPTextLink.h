...
#import "CMSComponentVIPTextLinkCellDelegate.h"

@class CMSComponentVIPTextLinkCell, NSString;

@interface CMSComponentVIPTextLink : CMSComponent <CMSComponentVIPTextLinkCellDelegate>
{
    CMSComponentVIPTextLinkCell *_textLinkCell;
}

@property(nonatomic) __weak CMSComponentVIPTextLinkCell *textLinkCell; // @synthesize textLinkCell=_textLinkCell;
- (void).cxx_destruct;
- (void)textLinkCell:(id)arg1 scrollIndex:(long long)arg2;
