...
+ (id)current;
+ (_Bool)isLogin;
+ (_Bool)isChangeVIPStateAPI;
+ (_Bool)hasEquityByEquityID:(id)arg1;
@property(retain, nonatomic) NSDictionary *eidInfoDict; // @synthesize eidInfoDict=_eidInfoDict;
...
- (void)equityIsChangedFromVIP:(id)arg1;
