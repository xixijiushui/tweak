...
@interface YKNDOPProgressSubView : UIView
{
    ...
    id <YKNDOPProgressSubViewDelegate> _delegate;
...
@property(nonatomic) __weak id <YKNDOPProgressSubViewDelegate> delegate; // @synthesize delegate=_delegate;
