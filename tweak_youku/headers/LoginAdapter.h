...
- (int)tryLogin:(id)arg1 isFromeBeforeLoginFilter:(_Bool)arg2 isForce:(_Bool)arg3;
- (int)tryLogin:(id)arg1 isFromeBeforeLoginFilter:(_Bool)arg2;
- (void)logout;
- (id)currentSession;
- (int)loginWithLoginOption:(int)arg1 isForce:(_Bool)arg2 isFromBeforeLoginFilter:(_Bool)arg3 extraInfo:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 cancelationHandler:(CDUnknownBlockType)arg6 request:(id)arg7;
