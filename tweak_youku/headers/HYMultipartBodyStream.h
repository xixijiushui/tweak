...
@class HYHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface HYMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    HYHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) HYHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
