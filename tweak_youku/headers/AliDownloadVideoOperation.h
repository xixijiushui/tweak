...
@class NSMutableArray, NSMutableURLRequest, NSObject<OS_dispatch_queue>, NSString, NSURLSessionTask;

@interface AliDownloadVideoOperation : NSOperation <NSURLSessionDataDelegate, NSURLConnectionDataDelegate>
{
    _Bool _executing;
    _Bool _finished;
