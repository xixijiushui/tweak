...
@class AVURLAsset, CPContentView, CPInterruption, CPModuleManager, CPPlayer, CPPlayerItem, CPPlayerView, NSArray, NSString;
...
@property(nonatomic) _Bool scaleFill; // @dynamic scaleFill;
- (void)stopLoading;
- (void)startLoading;
- (void)stopPending;
- (void)startPending;
