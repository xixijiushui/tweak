...
@class EPCTexture2D, GPBMessage, NSArray, NSAttributedString, NSCharacterSet, NSData, NSOutputStream, NSString, UIColor;
...
struct ArtcManager {
    ...
    int _field7;
    struct map<std::__1::basic_string<char>, int, std::__1::less<std::__1::basic_string<char>>, std::__1::allocator<std::__1::pair<const std::__1::basic_string<char>, int>>> _field8;
    int _field9;
    _Bool _field10;
    int _field11;
    _Bool _field12;
    ...
    struct recursive_mutex _field15;
    struct ArtcManagerLiveOption _field16;
    struct ArtcNativeEngine *_field17;
    void *_field18;
    void *_field19;
    struct Looper *_field20;
    struct Event *_field21;
    id _field22;
};
...
struct SoundTouch {
    CDUnknownFunctionPointerType *_vptr$FIFOSamplePipe;
    struct FIFOSamplePipe *output;
    struct RateTransposer *pRateTransposer;
    struct TDStretch *pTDStretch;
    float virtualRate;
    float virtualTempo;
    float virtualPitch;
    char bSrateSet;
...
struct _AliNNNet {
    struct _AliNNLayer **_field1;
    int _field2;
    struct _AliNNNetNode **_field3;
    ...
    CDUnknownFunctionPointerType _field10;
    char **_field11;
    struct _AliNNContext *_field12;
    struct _AliNNLayer *_field13[10];
    int _field14;
    struct _AliNNMutex *_field15;
    void *_field16;
    int _field17;
    int _field18;
};

struct _AliNNNetNode;
...
struct face_attribute_t;

struct face_attributes_t {
    struct face_attribute_t *_field1;
    int _field2;
};
...
typedef struct {
    ...
    union {
        ...
        struct {
            CDStruct_6181342a value;
            CDStruct_6181342a dephault;
        } cd;
        CDStruct_0bcbd2dc intd;
        struct {
            int value;
            int dephault;
            char pop_enums[256];
        ...
        struct {
            CDStruct_03942939 value;
            CDStruct_03942939 dephault;
        } p3d;
        struct {
            char path[256];
            char refid[64];
        } pathd;
        CDStruct_183601bc sd;
    } u;
    char name[64];
} CDStruct_f587da90;
