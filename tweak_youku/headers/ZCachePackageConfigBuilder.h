...
@class NSDictionary, NSMutableDictionary, NSString, ZCachePackageConfig;

@interface ZCachePackageConfigBuilder : NSObject
{
    _Bool _needSaveConfig;
    NSString *_version;
    long long _type;
    ZCachePackageConfig *_oldConfig;
...
@property(retain, nonatomic) ZCachePackageConfig *oldConfig; // @synthesize oldConfig=_oldConfig;
