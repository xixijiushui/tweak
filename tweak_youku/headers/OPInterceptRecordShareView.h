...
@interface OPInterceptRecordShareView : UIView <UIScrollViewDelegate>
{
    _Bool _shouldHideFanShareButton;
    OPPlugin *_plugin;
    id <OPInterceptRecordShareViewDelegate> _delegate;
...
@property(nonatomic) __weak id <OPInterceptRecordShareViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)createView;
- (id)initWithFrame:(struct CGRect)arg1 InterceptRecordType:(long long)arg2 shareItems:(id)arg3 withVideoId:(id)arg4 plugin:(id)arg5;
