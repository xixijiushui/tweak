...
#import "CMSComponentPrivateCinemaCellDelegate.h"

@class CMSComponentPrivateCinemaCell, NSString;

@interface CMSComponentPrivateCinema : CMSComponent <CMSComponentPrivateCinemaCellDelegate>
{
    CMSComponentPrivateCinemaCell *_privateCinemaCell;
}

@property(nonatomic) __weak CMSComponentPrivateCinemaCell *privateCinemaCell; // @synthesize privateCinemaCell=_privateCinemaCell;
- (void).cxx_destruct;
