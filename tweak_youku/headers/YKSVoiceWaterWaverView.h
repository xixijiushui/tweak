...
@interface YKSVoiceWaterWaverView : UIView
{
    ...
    NSMutableArray *_densitys;
}

@property(retain, nonatomic) NSMutableArray *densitys; // @synthesize densitys=_densitys;
...
@property(retain, nonatomic) NSMutableArray *waveColors; // @synthesize waveColors=_waveColors;
...
@property(nonatomic) double main2WaveWidth; // @synthesize main2WaveWidth=_main2WaveWidth;
