...
@class TBPLAppAutoCloseManager;

@interface TBPLAppTriggerService : TBPLBaseTriggerService
{
    TBPLAppAutoCloseManager *_autoCloseManager;
}

@property(retain, nonatomic) TBPLAppAutoCloseManager *autoCloseManager; // @synthesize autoCloseManager=_autoCloseManager;
- (void).cxx_destruct;
...
- (id)completedConfigs;
- (void)handleCompletedRequestsForPageTransitionEvent:(id)arg1;
