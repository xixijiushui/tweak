...
@class VIPChannelMovieRankCell, VIPYKChannelList;

@interface VIPCMSMovieRank : CMSComponent
{
    VIPChannelMovieRankCell *_cell;
    VIPYKChannelList *_rankList;
}

@property(retain, nonatomic) VIPYKChannelList *rankList; // @synthesize rankList=_rankList;
- (void).cxx_destruct;
- (id)moreSpmAtIndex;
