...
#import "ChannelSelectDelegate.h"

@class ChannelListCardManger, NSString;

@interface CMSComponentChannelList : CMSComponent <ChannelSelectDelegate>
{
    ChannelListCardManger *_listManager;
}
