...
@interface DYTrackerShowCard : CardController
{
...
- (id)scm_top;
- (id)scmWithCardVideo;
- (id)spm_bottom:(id)arg1 cardIndex:(long long)arg2;
- (id)spm_center:(id)arg1 cardIndex:(long long)arg2;
- (id)spm_top:(id)arg1 cardIndex:(long long)arg2;
