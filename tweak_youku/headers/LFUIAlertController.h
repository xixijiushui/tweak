...
#import "LFUIAlertActionDelegate.h"
#import "LFUIModalPresentationContentViewControllerProtocol.h"
#import "LFUIModalPresentationViewControllerDelegate.h"

@class LFUIAlertAction, LFUIModalPresentationViewController, NSArray, NSDictionary, NSMutableArray, NSString, UIColor, UIControl, UILabel, UIScrollView, UIView;

@interface LFUIAlertController : UIViewController <LFUIAlertActionDelegate, LFUIModalPresentationContentViewControllerProtocol, LFUIModalPresentationViewControllerDelegate>
{
    NSString *_title;
    ...
    id <LFUIAlertControllerDelegate> _delegate;
    UIView *_customView;
    NSString *_message;
    long long _preferredStyle;
    LFUIModalPresentationViewController *_modalPresentationViewController;
...
@property(retain, nonatomic) LFUIAlertAction *cancelAction; // @synthesize cancelAction=_cancelAction;
...
@property(retain, nonatomic) LFUIModalPresentationViewController *modalPresentationViewController; // @synthesize modalPresentationViewController=_modalPresentationViewController;
...
@property(nonatomic) __weak id <LFUIAlertControllerDelegate> delegate; // @synthesize delegate=_delegate;
