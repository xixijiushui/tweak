...
@class NSDictionary, NSString, SPMWatermarkDO, UIColor, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer;

@interface SPMStickerView : UIView <UIGestureRecognizerDelegate>
{
    ...
    id <SPMStickerViewDelegate> _delegate;
    UIView *_contentView;
    long long _minimumSize;
    UIColor *_outlineBorderColor;
    NSDictionary *_userInfo;
    SPMWatermarkDO *_markInfo;
...
@property(retain, nonatomic) SPMWatermarkDO *markInfo; // @synthesize markInfo=_markInfo;
...
@property(nonatomic) __weak id <SPMStickerViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)shotImage;
