...
@class NSString, YKStagePhotoSinglePhotoModelArray;

@interface YKStagePhotoAlbumAllPhotoView : YKStagePhotoCollectionView <UICollectionViewDelegate, UICollectionViewDataSource>
{
    long long _tabId;
    long long _tabType;
    ...
    YKStagePhotoSinglePhotoModelArray *_modelArray;
}

@property(retain, nonatomic) YKStagePhotoSinglePhotoModelArray *modelArray; // @synthesize modelArray=_modelArray;
