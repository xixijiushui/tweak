...
@interface DetailComponentSection : DetailComponentCommon <UIScrollViewDelegate, YKDetailRelateMoreListViewControllerDelegate>
{
    ...
    long long _compareIndexOfCurrentVid;
    struct CGRect _currentRect;
}

@property(nonatomic) struct CGRect currentRect; // @synthesize currentRect=_currentRect;
@property(nonatomic) long long compareIndexOfCurrentVid; // @synthesize compareIndexOfCurrentVid=_compareIndexOfCurrentVid;
