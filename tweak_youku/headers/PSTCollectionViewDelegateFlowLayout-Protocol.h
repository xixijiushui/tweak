...
@class NSIndexPath, NSString, PSTCollectionView, PSTCollectionViewLayout, PSTCollectionViewLayoutAttributes;

@protocol PSTCollectionViewDelegateFlowLayout <PSTCollectionViewDelegate>

@optional
- (PSTCollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)arg1 atIndexPath:(NSIndexPath *)arg2;
