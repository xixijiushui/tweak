...
@class SKSearchNoResultCardsController;

@interface SearchNoResultCard : SKNewCardController
{
}
...
@property(nonatomic) __weak SKSearchNoResultCardsController *cardsController; // @dynamic cardsController;
