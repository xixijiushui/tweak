...
#import "YTEnginePlayerExperienceDelegate.h"

@class NSMutableDictionary, NSObject<OS_dispatch_group>, NSString, NTDPlayerEngineStatisticsManager;
...
@interface NTDPlayerEngineStatisticsModule : NSObject <YTEnginePlayerExperienceDelegate, YTEngineModule>
{
    ...
    double _seekdoneTime;
}

@property(nonatomic) double seekdoneTime; // @synthesize seekdoneTime=_seekdoneTime;
