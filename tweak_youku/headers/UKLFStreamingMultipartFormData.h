...
#import "UKLFMultipartFormData.h"

@class NSMutableURLRequest, NSString, UKLFMultipartBodyStream;

@interface UKLFStreamingMultipartFormData : NSInputStream <UKLFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    UKLFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) UKLFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
