...
#import "YTEngineYoukuPlatformDataSource.h"
...
+ (void)netcacheDiskCheck:(CDUnknownBlockType)arg1;
...
- (void)playVideo:(id)arg1 quality:(id)arg2 from:(float)arg3 enableAD:(_Bool)arg4;
...
- (void)playPreloadVid:(id)arg1;
- (void)playPreloadVid:(id)arg1 from:(float)arg2;
- (void)playVid:(id)arg1 quality:(id)arg2 password:(id)arg3 from:(float)arg4 extraInfo:(id)arg5;
...
@property(readonly, retain, nonatomic) NSArray *videodbTypes;
...
- (void)stopLiveVideo;
- (void)playLive:(id)arg1 extraInfo:(id)arg2;
...
- (void)player:(id)arg1 renderSnapshotImageNameUpload:(id)arg2;
- (void)playerRenderSnapshotImageEnd:(id)arg1;
- (void)player:(id)arg1 renderSnapshotVideoError:(int)arg2;
- (void)player:(id)arg1 renderSnapshotVideoProgress:(int)arg2;
- (void)playerRenderSnapshotVideoEnd:(id)arg1;
...
- (void)playerFeedback:(id)arg1 errorInfo:(id)arg2 block:(CDUnknownBlockType)arg3;
...
- (void)player:(id)arg1 updateLiveStreamSeiInfo:(id)arg2;
- (void)player:(id)arg1 updateBufferStateInfo:(id)arg2;
...
- (id)p_convertLightVideoItemToYoukuInstanceItem:(id)arg1;
...
@property(nonatomic) _Bool appleADVideo;
