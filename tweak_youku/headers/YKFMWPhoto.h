...
@class ELCAsset, NSData, NSString, NSURL, PHAsset, TBAnimatedImage, UIImage;
...
+ (id)photoWithElcAsset:(id)arg1 targetSize:(struct CGSize)arg2;
...
- (void)_performLoadUnderlyingImageAndNotifyWithElcAsset:(id)arg1;
...
- (id)initWithElcAsset:(id)arg1 targetSize:(struct CGSize)arg2;
