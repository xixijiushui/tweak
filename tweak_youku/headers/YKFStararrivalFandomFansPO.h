...
@class NSString, YKFStararrivalExpLevelItemPO, YKFStararrivalManagerGroupInfoPO, YKFStararrivalManagerRoleInfoPO, YKFStararrivalMemberRolePO, YKFStararrivalNameplatePO;

@interface YKFStararrivalFandomFansPO : YKFAPIModel
{
    _Bool _isBlack;
