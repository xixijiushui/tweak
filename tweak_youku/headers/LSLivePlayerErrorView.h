...
@class LSLivePlayer, NSString, UIButton, UIImageView, UILabel;
...
- (id)getErrorMessage;
- (void)wxCheckError;
- (void)showFakeErrorView:(unsigned long long)arg1 withErrorMsg:(id)arg2;
- (_Bool)isBlankString:(id)arg1;
- (void)updateErrorTextLabel:(id)arg1;
- (void)playLiveVideo;
