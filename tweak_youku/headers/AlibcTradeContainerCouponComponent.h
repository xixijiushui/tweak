...
- (void)asyncCouponGetWithQueryParams:(id)arg1 taokeParams:(id)arg2 trackParams:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failedBlock:(CDUnknownBlockType)arg5;
