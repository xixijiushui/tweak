...
@class DetailTuwenDoubanCommentModel, UIImageView, YYLabel;

@interface DetailTuwenDoubanCommentCell : UICollectionViewCell
{
    DetailTuwenDoubanCommentModel *_item;
...
@property(retain, nonatomic) DetailTuwenDoubanCommentModel *item; // @synthesize item=_item;
- (void).cxx_destruct;
- (void)layoutSubviews;
