...
@class UITouch, UIView, YKCutHandler, YKImageCollectionView;

@interface YKCutSlider : UIControl
{
    ...
    double _maxValue;
    double _minSpace;
    YKCutHandler *_leftHandler;
    YKCutHandler *_rightHandler;
...
@property(retain, nonatomic) YKCutHandler *rightHandler; // @synthesize rightHandler=_rightHandler;
@property(retain, nonatomic) YKCutHandler *leftHandler; // @synthesize leftHandler=_leftHandler;
