...
@interface ReflectClient : NSObject <NSNetServiceBrowserDelegate, NSNetServiceDelegate, NSStreamDelegate>
{
    struct {
    ...
    NSString *_type;
    id <ReflectClientDelegate> _delegate;
    NSString *_passcode;
...
@property(nonatomic) __weak id <ReflectClientDelegate> delegate; // @synthesize delegate=_delegate;
