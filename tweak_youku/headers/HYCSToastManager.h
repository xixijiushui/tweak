...
@class HYCSToastStyle;

@interface HYCSToastManager : NSObject
{
    _Bool _tapToDismissEnabled;
    _Bool _queueEnabled;
    HYCSToastStyle *_sharedStyle;
...
@property(retain, nonatomic) HYCSToastStyle *sharedStyle; // @synthesize sharedStyle=_sharedStyle;
- (void).cxx_destruct;
- (id)init;
