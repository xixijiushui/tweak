...
#import "ImageLibNetworkNofityProtocol.h"
...
- (void)sd_setImageWithURL:(id)arg1 module:(id)arg2 placeholderImage:(id)arg3 imageSize:(struct CGSize)arg4 cutType:(long long)arg5 options:(unsigned long long)arg6 progress:(CDUnknownBlockType)arg7 transform:(CDUnknownBlockType)arg8 completed:(CDUnknownBlockType)arg9;
...
@property(retain, nonatomic) NSArray *sd_imageRunloopModes;
@property(retain, nonatomic) NSURL *sd_imageURL;
@property(retain, nonatomic) NSURL *sd_originalImageURL;
