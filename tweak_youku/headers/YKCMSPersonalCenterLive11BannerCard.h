...
@class NSMutableArray, UIImage, YKCMSPersonalCenterCardVideo, YKJSONClient;

@interface YKCMSPersonalCenterLive11BannerCard : ComponentCard
{
    double _imageWidth;
    double _imageHeight;
    _Bool _isLoading;
...
- (void).cxx_destruct;
- (void)unsubscribe;
- (void)refreshImageByAppointmentState;
- (void)sendCMSStatis;
- (_Bool)isGIFBanner;
- (void)loadImage;
