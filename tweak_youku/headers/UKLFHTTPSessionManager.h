...
#import "UKLFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class NSURL, UKLFHTTPRequestSerializer<UKLFURLRequestSerialization>, UKLFHTTPResponseSerializer<UKLFURLResponseSerialization>;

@interface UKLFHTTPSessionManager : UKLFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    UKLFHTTPRequestSerializer<UKLFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) UKLFHTTPRequestSerializer<UKLFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) UKLFHTTPResponseSerializer<UKLFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
