...
+ (_Bool)currentNetworkIsCellular;
...
@property(nonatomic) _Bool isCellularNetwork; // @synthesize isCellularNetwork=_isCellularNetwork;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool decompressImages;
- (_Bool)checkOssDomain:(id)arg1;
- (_Bool)checkGifOssDomain:(id)arg1;
- (double)gifOssQuality;
- (_Bool)gifOssScaleSwitch;
- (id)gifOssDomains;
- (_Bool)gifOssSwitch;
- (id)limitDomains;
- (_Bool)freeDataSwitch;
- (id)freeDataDomains;
- (id)freeDataOriginDomains;
- (id)getOriginDomainForFreeDataDomain:(id)arg1;
- (id)getFreeDataDomainForOriginDomain:(id)arg1;
...
- (void)updateConfigByDictionary:(id)arg1;
