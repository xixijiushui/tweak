...
#import "XAdEngineImageAdViewDelegate.h"
#import "XAdVideoDataSource.h"
#import "YTEngineModule.h"

@class ADRequestDataSource, NSArray, NSString, XAdEngineBusinessModule, XAdEnginePlayerAdItem, XAdNavigator, XAdVideoExposure, YTEngineScreenMode;
...
- (void)uninstallLiveScreenObservers;
- (void)installLiveScreenObservers;
- (_Bool)needAd;
- (void)dealloc;
- (void)moduleReset;
- (id)init;
