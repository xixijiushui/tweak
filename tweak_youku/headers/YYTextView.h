...
@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIColor, UIFont, UIImageView, UITextPosition, UITextRange, UIView, YKFUIThemeColorPicker, YKFUIThemeKeyboardAppearancePicker, YYTextContainer, YYTextContainerView, YYTextDebugOption, YYTextHighlight, YYTextLayout, YYTextMagnifier, YYTextRange, YYTextSelectionView;
