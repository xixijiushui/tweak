...
@class CALayer, NSArray, NSDictionary, UIColor, UIView, YKStagePhotoScrollView;

@interface YKStagePhotoSegmentedControl : UIControl
{
    ...
    YKStagePhotoScrollView *_scrollView;
    struct UIEdgeInsets _selectionIndicatorEdgeInsets;
    struct UIEdgeInsets _segmentEdgeInset;
}

@property(retain, nonatomic) YKStagePhotoScrollView *scrollView; // @synthesize scrollView=_scrollView;
