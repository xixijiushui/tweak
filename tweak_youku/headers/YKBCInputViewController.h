...
@class YKBCCommentHeaderInputView, YKBCInputWindow;

@interface YKBCInputViewController : UIViewController
{
    _Bool _landScape;
    _Bool _isAddNotification;
    YKBCCommentHeaderInputView *_inputView;
    YKBCInputWindow *_ownerWindow;
}
...
@property(nonatomic) __weak YKBCInputWindow *ownerWindow; // @synthesize ownerWindow=_ownerWindow;
@property(retain, nonatomic) YKBCCommentHeaderInputView *inputView; // @synthesize inputView=_inputView;
- (void).cxx_destruct;
- (void)showInputView;
