...
@interface YKLSWordLiveController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LSWebSocketDelegate, LSDetailTabControllerDelegate>
{
