...
#import "LSWordEventDelegate.h"
#import "UIWebViewDelegate.h"

@class LSCallback, LSJSProcess, LSLiveInfoModel, LSLivePlayerDataManager, NSMutableDictionary, NSObject<UIWebViewDelegate>, NSString, UIButton;
