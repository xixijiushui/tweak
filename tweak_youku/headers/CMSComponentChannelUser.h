...
#import "ChannelUserCellDelegate.h"

@class ChannelUser, NSString;

@interface CMSComponentChannelUser : CMSComponent <ChannelUserCellDelegate>
{
    ChannelUser *_channelUser;
}

@property(retain, nonatomic) ChannelUser *channelUser; // @synthesize channelUser=_channelUser;
- (void).cxx_destruct;
