...
@class NSArray, NSMutableArray, NSString, SPMMutiSelectionTabbarView, UIButton, UIScrollView, UIView;

@interface SPMPhotoBrowserViewController : UIViewController <UIScrollViewDelegate, SPMMutiSelectionTabbarDelegate, UIActionSheetDelegate>
{
    ...
    id <SPMPhotoBrowserViewDelegate> _delegate;
    NSArray *_photoArray;
...
@property(nonatomic) __weak id <SPMPhotoBrowserViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)SPMMutiSelectionTabbar:(id)arg1 shouldEditAssets:(id)arg2;
