...
#import "HYUserClausesViewDelegate.h"
...
@interface HYUserMobileLoginViewController : HYUserBaseLoginViewController <HYCountDownTimeDelegate, HYUserClausesViewDelegate, HYCountryListDelegate, HYUserSDKInputCellDelegate>
{
    int _viewType;
...
- (void)userDidAcceptAllClausesWithAuthCodeInfo:(id)arg1;
- (void)showUserClausesViewWithRegAuthCodeInfo:(id)arg1;
