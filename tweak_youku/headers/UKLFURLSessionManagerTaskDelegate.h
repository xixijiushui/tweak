...
@class NSMutableData, NSProgress, NSString, NSURL, UKLFURLSessionManager;

@interface UKLFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    UKLFURLSessionManager *_manager;
...
@property(nonatomic) __weak UKLFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
