...
@class NSArray, NSString, TBAnimatedImage, UIColor, VIPPubPraiseTopView, YKPagesManager;

@interface VIPPubPraiseMainViewController : UIBaseViewController <YKPagesManagerDelegate>
{
