...
#import "HYURLConnectionOperation.h"

@class HYHTTPResponseSerializer<HYURLResponseSerialization>, NSError, NSHTTPURLResponse, NSRecursiveLock;

@interface HYHTTPRequestOperation : HYURLConnectionOperation
{
