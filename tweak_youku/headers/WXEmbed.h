...
@interface WXEmbed : WXComponent
{
    ...
    unsigned long long _memoryStategy;
}

@property(nonatomic) unsigned long long memoryStategy; // @synthesize memoryStategy=_memoryStategy;
...
@property(retain, nonatomic) NSString *degradeUrl; // @synthesize degradeUrl=_degradeUrl;
...
- (void).cxx_destruct;
- (id)retrieveEmbedComponents;
- (void)evaluateMemoryStatus;
- (void)wxCaculateNumOfComponent;
