...
@interface MtopService : NSObject <TBSDKRequestDelegate>
{
    ...
    id <TBSDKFilterManagerProtocol> _filterManager;
}

+ (id)getInstance;
@property(retain, nonatomic) id <TBSDKFilterManagerProtocol> filterManager; // @synthesize filterManager=_filterManager;
- (void).cxx_destruct;
...
- (void)installFilterManager:(id)arg1;
- (id)init;
