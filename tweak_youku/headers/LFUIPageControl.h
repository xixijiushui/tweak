...
@interface LFUIPageControl : UIControl
{
    unsigned long long _displayedPage;
...
- (id)nameForPage:(unsigned long long)arg1;
- (void)setName:(id)arg1 forPage:(unsigned long long)arg2;
...
- (void)setCurrentPage:(unsigned long long)arg1 sendEvent:(_Bool)arg2 canDefer:(_Bool)arg3;
...
- (id)imageMaskForPage:(unsigned long long)arg1;
- (id)currentImageForPage:(unsigned long long)arg1;
- (id)imageForPage:(unsigned long long)arg1;
- (id)_imageForPage:(unsigned long long)arg1 type:(unsigned long long)arg2;
- (void)setImageMask:(id)arg1 forPage:(unsigned long long)arg2;
- (void)setCurrentImage:(id)arg1 forPage:(unsigned long long)arg2;
- (void)setImage:(id)arg1 forPage:(unsigned long long)arg2;
- (void)_setImage:(id)arg1 forPage:(unsigned long long)arg2 type:(unsigned long long)arg3;
- (struct CGRect)rectForPageIndicator:(unsigned long long)arg1;
- (struct CGSize)sizeForNumberOfPages:(unsigned long long)arg1;
