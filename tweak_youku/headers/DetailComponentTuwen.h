...
@interface DetailComponentTuwen : DetailComponentCommon
{
    _Bool _shouldShowOneFullCell;
    NSArray *_list;
}

@property(nonatomic) _Bool shouldShowOneFullCell; // @synthesize shouldShowOneFullCell=_shouldShowOneFullCell;
