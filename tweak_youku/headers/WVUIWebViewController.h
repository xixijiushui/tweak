...
@class NSArray, NSString, NSURL, NSURLRequest, UIColor, UIScrollView, UIView, UIView<WVWebViewProtocol>, WVNavigationBarBackgroundStatus, WVUIButtonItem, WVUIErrorView, WVUILoadingBox, WVUserContentController, WVWebViewToolbar;
