...
@class NSAttributedString, NSString, RevolveTitle, UIButton, UIImageView, UILabel;

@interface SPOperationTask : SPModuleTask
{
    _Bool _showBrief;
    _Bool _showMoveText;
...
@property(readonly, nonatomic) RevolveTitle *moveLabel; // @synthesize moveLabel=_moveLabel;
