...
@protocol ChildBaseUserTrackProtocol
...
- (void)collectCustomEventWithEventID:(NSString *)arg1 pageName:(NSString *)arg2 arg1:(NSString *)arg3 arg2:(NSString *)arg4 args:(NSDictionary *)arg5;
@end
