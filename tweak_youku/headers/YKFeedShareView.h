...
@class CALayer, NSArray, NSMutableArray, NSString, UICollectionView, UIWindow, YKFeedShareInfo;

@interface YKFeedShareView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, YKShareCenterDelegate>
{
    NSArray *_customArrayInfoDic;
    YKFeedShareInfo *_shareInfo;
    id <YKFeedShareViewDelegate> _delegate;
    UIView *_drawer;
...
@property(nonatomic) __weak id <YKFeedShareViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) YKFeedShareInfo *shareInfo; // @synthesize shareInfo=_shareInfo;
