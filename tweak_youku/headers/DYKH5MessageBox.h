...
@class DYKH5MessageBoxView, NSMutableArray;

@interface DYKH5MessageBox : NSObject
{
    _Bool _isRichText;
    int _messageViewOprientation;
    int _DYKH5MessageBoxMode;
    NSMutableArray *_messageQueue;
    DYKH5MessageBoxView *_DYKH5MessageBoxView;
}

+ (id)sharedInstance;
@property(nonatomic) _Bool isRichText; // @synthesize isRichText=_isRichText;
@property(retain, nonatomic) DYKH5MessageBoxView *DYKH5MessageBoxView; // @synthesize DYKH5MessageBoxView=_DYKH5MessageBoxView;
@property(retain, nonatomic) NSMutableArray *messageQueue; // @synthesize messageQueue=_messageQueue;
@property(nonatomic) int DYKH5MessageBoxMode; // @synthesize DYKH5MessageBoxMode=_DYKH5MessageBoxMode;
