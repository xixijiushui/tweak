...
@class CADisplayLink, NSMutableDictionary, NSObject<OS_dispatch_semaphore>, NSOperationQueue, NSString, UIImage, UIImage<LFAnimatedImage>;

@interface LFUIFrameImageView : UIImageView
{
    UIImage<LFAnimatedImage> *_curAnimatedImage;
