...
@interface YYTextLayout : NSObject <NSCoding>
{
    ...
    CDStruct_8caa76fc *_lineRowsEdge;
...
+ (id)layoutForAttributeText:(id)arg1 maxWidth:(double)arg2 maxNumOfRows:(long long)arg3;
@property(nonatomic) CDStruct_8caa76fc *lineRowsEdge; // @synthesize lineRowsEdge=_lineRowsEdge;
