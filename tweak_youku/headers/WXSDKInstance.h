...
@class KSInstance, NSDictionary, NSMutableDictionary, NSString, NSURL, UIView, UIViewController, WXComponentManager, WXResourceLoader, WXRootView, WXThreadSafeMutableDictionary;
...
@property(nonatomic) __weak KSInstance *ks_instance;
