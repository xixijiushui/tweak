...
@class MPMoviePlayerViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIColor, UIImage, UIScrollView, UIToolbar, UIView, YKFMBProgressHUD, YKFMWGridViewController;

@interface YKFMWPhotoBrowser : YKFBaseViewController <UIScrollViewDelegate, UIActionSheetDelegate>
{
    ...
    YKFMBProgressHUD *_progressHUD;
    UIView *_customizedNavigationView;
    UIView *_customizedToolBar;
    YKFMWGridViewController *_gridController;
    ...
    _Bool _enableTapToDismissWithoutDoneButton;
    _Bool _shouldHideControlWhenScrolling;
    _Bool _dragDownToDismiss;
    _Bool _startOnGrid;
    _Bool _autoPlayOnAppear;
    id <YKFMWPhotoBrowserDelegate> _delegate;
...
@property(nonatomic) _Bool dragDownToDismiss; // @synthesize dragDownToDismiss=_dragDownToDismiss;
@property(nonatomic) _Bool shouldHideControlWhenScrolling; // @synthesize shouldHideControlWhenScrolling=_shouldHideControlWhenScrolling;
@property(nonatomic) _Bool enableTapToDismissWithoutDoneButton; // @synthesize enableTapToDismissWithoutDoneButton=_enableTapToDismissWithoutDoneButton;
...
@property(nonatomic) __weak id <YKFMWPhotoBrowserDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (_Bool)canDismissWithGesture;
- (_Bool)shouldHideNavigationBar;
- (void)backPanEvent:(id)arg1;
- (id)panGestureRecognizerOfPagingScrollView;
- (void)actuallyCopyPhoto:(id)arg1;
- (void)copyPhoto;
- (void)image:(id)arg1 didFinishSavingWithError:(id)arg2 contextInfo:(void *)arg3;
- (void)actuallySavePhoto:(id)arg1;
- (void)saveGifToAlbum:(id)arg1;
- (void)savingPhotoHandlerWithError:(id)arg1;
- (void)showSavingErrorAlert;
- (void)savePhoto;
...
- (struct CGRect)frameForNavigationViewAtOrientation:(long long)arg1;
- (struct CGRect)frameForCustomizedToolbarAtOrientation:(long long)arg1;
...
- (void)tilePages;
- (void)handleYKFMWPhotoLoadingDidEndNotification:(id)arg1;
