...
@class NSString, OPConsoleBubbleLayoutModel, OPInterceptButton, UIButton;

@interface OPInterceptView : UIView <OPInterceptButtonDelegate>
{
    UIButton *_imageShotButton;
    OPInterceptButton *_gifShotButton;
    OPConsoleBubbleLayoutModel *_bubbleLayout;
    id <OPInterceptViewDelegate> _delegate;
}

@property(nonatomic) __weak id <OPInterceptViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
