...
- (_Bool)isRunning;
- (void)cancelAll;
- (id)inner_downloadImageWithURL:(id)arg1 module:(id)arg2 viewSize:(struct CGSize)arg3 options:(unsigned long long)arg4 progress:(CDUnknownBlockType)arg5 transform:(CDUnknownBlockType)arg6 completed:(CDUnknownBlockType)arg7;
- (id)downloadImageWithURL:(id)arg1 module:(id)arg2 imageSize:(struct CGSize)arg3 viewSize:(struct CGSize)arg4 cutType:(long long)arg5 options:(unsigned long long)arg6 progress:(CDUnknownBlockType)arg7 transform:(CDUnknownBlockType)arg8 completed:(CDUnknownBlockType)arg9;
...
- (id)createCache;
- (id)init;
- (void)yk_imageWithURLString:(id)arg1 clipToDonutCircle:(_Bool)arg2 success:(CDUnknownBlockType)arg3;
