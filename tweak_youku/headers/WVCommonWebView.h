...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, UIView<WVWebViewProtocol>, UIViewController, WVJavascriptApplication, WVNavigation, WVUserContentController, WVWebViewLongPressImage, WVWebViewPerfRecorder;
