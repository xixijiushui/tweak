...
#import "HYMultipartFormData.h"

@class HYMultipartBodyStream, NSMutableURLRequest, NSString;

@interface HYStreamingMultipartFormData : NSObject <HYMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    HYMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) HYMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
