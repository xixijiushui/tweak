...
+ (id)getMtopSignWithAppkey:(id)arg1 withApiName:(id)arg2 withApiVersion:(id)arg3 withT:(id)arg4 withSid:(id)arg5 withTtid:(id)arg6 withDeviceId:(id)arg7 withLatitude:(id)arg8 withLongitude:(id)arg9 withEcode:(id)arg10 withData:(id)arg11 withHeader:(id)arg12 mtopType:(unsigned long long)arg13;
+ (id)shareInstance;
