...
@class VIPCubeMainViewController;

@interface VIPCubeViewController : ComponentCardsController
{
}
...
@property(nonatomic) __weak VIPCubeMainViewController *superViewController;
