...
#import "OPPlayButtonViewDelegate.h"

@class NSMutableArray, NSString, OPLayoutModel, OPPlayButtonView;

@interface OPCenterPlayPlugin : OPPlugin <OPPlayButtonViewDelegate, OPLayoutModelDelegate>
{
    OPPlayButtonView *_playButton;
...
@property(retain, nonatomic) OPPlayButtonView *playButton; // @synthesize playButton=_playButton;
- (void).cxx_destruct;
