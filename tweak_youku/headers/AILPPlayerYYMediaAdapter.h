...
@class LSLiveAdapterModel, MPVolumeView, NSDictionary, NSMutableArray, NSString, UISlider, UIView, YKLPlayerTouch, YKLPlayerYYConfig, YKLPlayerYYControl, YKLPlayerYYFeatures, YYMediaPlayer;

@interface AILPPlayerYYMediaAdapter : NSObject <YYMediaPlayerEvents, YKLPlayerTouchDelegate, UIGestureRecognizerDelegate, UIAlertViewDelegate, AILPPlayerProtocol, AILPPlayerEventInfoProtocol>
{
    _Bool _muted;
    _Bool _isScreenshot;
    _Bool _isSmoothMode;
    ...
    UIView *_yyPlayView;
    YKLPlayerYYConfig *_yyConfig;
    YKLPlayerYYFeatures *_yyFratures;
    YKLPlayerYYControl *_yyPlayControl;
...
@property(retain, nonatomic) YKLPlayerYYControl *yyPlayControl; // @synthesize yyPlayControl=_yyPlayControl;
@property(retain, nonatomic) YKLPlayerYYFeatures *yyFratures; // @synthesize yyFratures=_yyFratures;
@property(retain, nonatomic) YKLPlayerYYConfig *yyConfig; // @synthesize yyConfig=_yyConfig;
@property(retain, nonatomic) UIView *yyPlayView; // @synthesize yyPlayView=_yyPlayView;
...
- (void)stopDlna;
- (void)searchDlna;
- (void)playerUpdateLiveStreamSeiInfo:(id)arg1;
