...
@class ChildOPAppInterceptorService;

@interface ChildOPAppInterceptorPlugin : OPPlugin
{
    ChildOPAppInterceptorService *_interceptorService;
}

@property(retain, nonatomic) ChildOPAppInterceptorService *interceptorService; // @synthesize interceptorService=_interceptorService;
- (void).cxx_destruct;
- (void)refreshPlay;
