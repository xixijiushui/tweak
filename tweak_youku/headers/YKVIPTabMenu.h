...
@class NSArray, NSMutableArray, NSString, UIColor, UIFont, UIScrollView, YKVIPTabMenuViewCell;

@interface YKVIPTabMenu : UIView <UIScrollViewDelegate>
{
    NSMutableArray *_itemsArray;
    UIScrollView *_scrollView;
    UIView *_selectedView;
    YKVIPTabMenuViewCell *_currentIndexView;
    long long _currentIndex;
    double _scaleSpace;
    UIFont *_selectedFont;
    UIFont *_unselectedFont;
    double _unselectedFontSize;
    _Bool _showSelectedSlider;
    _Bool _selectedBold;
    id <YKVIPTabMenuDelegate> _delegate;
    NSArray *_menuItems;
...
@property(retain, nonatomic) UIColor *selectedSliderColor; // @synthesize selectedSliderColor=_selectedSliderColor;
...
@property(nonatomic) __weak id <YKVIPTabMenuDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)dealloc;
...
- (void)hideViewShadow;
- (void)showViewShadow;
- (void)setCurrenrSelectItemScaleWithScale:(double)arg1;
- (void)reloadTabMenuItemsUI;
- (struct CGRect)setSelectedViewFrameWith:(id)arg1;
...
- (void)setupMenuItems;
- (id)setItemTextSelectFontWithScale:(double)arg1;
- (id)setItemTextFontWithScale:(double)arg1;
- (id)setItemSelectedFont;
- (id)setItemUnselectedFont;
