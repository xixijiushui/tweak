...
@class AliUIHUDBackgroundView, CADisplayLink, NSArray, NSDate, NSProgress, NSTimer, UIButton, UIColor, UILabel;

@interface AliUIProgressHUD : UIView
{
    ...
    float _progress;
    id <AliUIProgressHUDDelegate> _delegate;
    ...
    double _margin;
    double _insertMargin;
    NSProgress *_progressObject;
    AliUIHUDBackgroundView *_bezelView;
    AliUIHUDBackgroundView *_backgroundView;
    UIView *_customView;
    UILabel *_label;
...
@property(readonly, nonatomic) AliUIHUDBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(readonly, nonatomic) AliUIHUDBackgroundView *bezelView; // @synthesize bezelView=_bezelView;
...
@property(nonatomic) double insertMargin; // @synthesize insertMargin=_insertMargin;
...
@property(nonatomic) __weak id <AliUIProgressHUDDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
